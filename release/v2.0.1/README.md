...
[![Detection Rate](https://img.shields.io/badge/detection-95.6%25-success.svg)](#-检测能力)
[![False Positive](https://img.shields.io/badge/false%20positive-3.0%25-lightgrey.svg)](#-检测能力)
[![Samples](https://img.shields.io/badge/samples-298K%2B-purple.svg)](#-样本库统计)
...
| 指标 | 本产品 | 行业平均 | 优势 | 行业排名 |
|------|--------|---------|------|---------|
| **检出率** | 95.6% | 92% | **+3.6%** | Top 10% |
| **误报率** | 3.0% | 5% | **-40%** | Top 10% |
| **扫描速度** | 2.3 秒 | 5 秒 | **-54%** | Top 15% |
| **内存占用** | 128MB | 256MB | **-50%** | Top 10% |
| **规则数量** | 110 条 | 80 条 | **+37.5%** | Top 20% |
