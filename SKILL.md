...
description: Enterprise AI Agent Security Scanner - 846 rules, hybrid detection, risk tier classification. Detects prompt injection, credential theft, data exfiltration, and attack chains.
version: 6.2.0
---
...
**v6.2.0** | **846 Rules** | **Risk Tier Classification** | **Attack Chain Detection**
