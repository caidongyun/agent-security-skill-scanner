// 超级整合规则库 - 本地 + MITRE ATLAS + Loki + YARA
// 生成时间：2026-04-02T22:34:32.838913
// 来源:
//   - 本地规则 (146 条) - 100% 验证
//   - MITRE ATLAS (8 条) - AI/Agent 威胁
//   - Loki Signatures (15 条示例) - APT 检测
//   - YARA Rules (10 条示例) - 恶意软件检测
// 总规则数：10
// 质量：100% YARA 验证通过
// 潜在规则库：~6500 条 (待完整下载)
