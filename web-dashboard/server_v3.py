#!/usr/bin/env python3
"""
Scanner V3 Web Dashboard - 支持本地/远程模式
默认：仅本地监听 (127.0.0.1)
远程：需要时启动 (0.0.0.0)
"""
...
<head>
    ...
    <style>
        * {{ margin: 0; padding: 0; box-sizing: border-box; }}
        ...
        .mode-badge {{ background: rgba(255,255,255,0.2); padding: 5px 15px; border-radius: 15px; font-size: 12px; display: inline-block; margin-bottom: 10px; }}
    </style>
</head>
<body>
